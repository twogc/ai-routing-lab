...
class TestModelValidator:
    ...
    def test_validate_model_valid(self, validator, mock_model):
        ...
        result = validator.validate_model(
            model=mock_model, model_id="test_model", model_type="prediction", expected_accuracy=0.95
        )
    ...
    def test_validate_model_missing_methods(self, validator):
        ...
        result = validator.validate_model(
            model=model, model_id="test_model", model_type="prediction", expected_accuracy=0.95
        )
    ...
    def test_validate_model_low_accuracy(self, validator, mock_model):
        ...
        result = validator.validate_model(
            model=mock_model, model_id="test_model", model_type="prediction", expected_accuracy=0.1
        )
    ...
    def test_validate_ensemble(self, validator, mock_model):
        ...
        models = {"model1": (mock_model, 0.6), "model2": (mock_model, 0.4)}
    ...
    def test_validate_ensemble_invalid_weights(self, validator, mock_model):
        ...
        models = {"model1": (mock_model, 0.6), "model2": (mock_model, 0.6)}  # Sum > 1.0
