...
**Уникальная особенность проекта:** интеграция с [CAI Framework](https://github.com/cai-framework) для создания AI-агентов, автоматизирующих сетевые задачи.
...
Подробная документация: [`docs/labs/CAI_INTEGRATION.md`](docs/labs/CAI_INTEGRATION.md)
